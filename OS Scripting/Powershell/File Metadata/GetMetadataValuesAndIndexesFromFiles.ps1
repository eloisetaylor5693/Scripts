# ET Comment:
#   Use this script to find the index value for the file attribute you are interested n
#   Then tailor the script to find the attributes you want
...
$picsDir = "C:\Pictures\Pets"

Get-FileMetaData -folder $picsDir | Export-Csv $picsDir"\cats.csv"